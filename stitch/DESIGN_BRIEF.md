...
- SignalShelf Mini turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a tiny single-page tool called SignalShelf Mini. It should show four status cards, one search box, one filter select, a compact event list, and a details drawer. Use plain HTML, CSS, and JavaScript only, persist filter and drawer state in localStorage, and include clear empty and recovery states.
...
- Record Operations - SignalShelf Mini
- Record Editor - SignalShelf Mini
- Settings and Preferences - SignalShelf Mini
- Empty and Error Recovery - SignalShelf Mini

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Record Operations - SignalShelf Mini
...
SCREEN_SPEC_2:
- exact_screen_title: Record Editor - SignalShelf Mini
...
SCREEN_SPEC_3:
- exact_screen_title: Settings and Preferences - SignalShelf Mini
...
SCREEN_SPEC_4:
- exact_screen_title: Empty and Error Recovery - SignalShelf Mini
